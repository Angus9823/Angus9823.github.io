...
mathjax: true
description: >-
  【 统计SQL的查询成本：last_query_cost、定位执行慢的SQL：慢查询日志、**查看** **SQL** **执行成本：SHOW
  PROFILE、分析查询语句：EXPLAIN、EXPLAIN的进一步使用、分析优化器执行计划：trace、 MySQL监控分析视图-sys schema】
abbrlink: 7ccee7a8
date: 2023-04-18 15:36:07
---
